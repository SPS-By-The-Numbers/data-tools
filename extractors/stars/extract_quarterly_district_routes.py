#!python3
"""Walk a directory of Quarterly District Detail files, emit per-route rows.

Usage:
    python3 -m extractors.stars.extract_quarterly_district_routes data/stars/quarterly_district/
"""
...
from .parsers.quarterly_district import parse_quarterly_district_routes
...
def main():
    ...
    for path in files:
        ...
        try:
            rows = list(parse_quarterly_district_routes(info))
        ...
        if args.format == "summary":
            ...
            if writer is None:
                fieldnames = list(rows[0].keys()) if rows else [
                    ...
                    "quarter", "program", "route_number",
                    "district_bus_number", "state_bus_number",
                    "destination_name", "stop_count", "total_stops",
                    "average_distance",
