#!python3
"""Walk a directory of Quarterly District Detail files, parse each, emit records.

Usage:
    python3 -m extractors.stars.extract_quarterly_district data/stars/quarterly_district/
"""
...
from .parsers.quarterly_district import parse_quarterly_district
...
def main():
    ...
    for path in files:
        ...
        try:
            rows = list(parse_quarterly_district(info))
